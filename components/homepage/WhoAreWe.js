        ...
        <>
            ...
            <Container className='py-5'>
                <Row className='d-flex flex-column align-items-center'>
                    <h1 className='dosis-regular text-center'>Our Differentiators</h1>
            ...
            <Container>
                <Row className='d-flex d-md-row justify-content-center'>
                    <Row className='d-flex flex-md-row flex-column'>
                        ...
                        <Col className='d-flex flex-column justify-content-between our-dirc-1  p-md-5 laro-regular p-5 ' >
            ...
            <Container>
                <Row className='p-md-5 '>
                    <Col md={4} >
                        <h1 className='dosis-regular w-50 d-md-block d-none'>Our Impact</h1>
                        <h1 className='dosis-regular w-100 d-md-none d-block p-5 text-center'>Our Impact</h1>
                        <hr className='w-50 border border-3 border-black d-none d-md-block ' />
                    </Col>
                    ...
                    <Col className='w-100 '>
                        ...
                        <Row className='text-center d-flex flex-column text-center flex-md-row'>
                            ...
                            <Col className=''>
                                <NumberCounter start={0} end={13500} symbol="+" title="States we work in" />
                            </Col>
                        </Row>
                        <Row className=' text-center d-flex flex-column text-center flex-md-row'>
                            <Col className=''>
            ...
            <Container fluid className='parters-bg'>
                <Container>
                    <Col className='text-center'>
                        <h1 className='dosis-regular d-md-block d-none border-0 border-bottom text-center  border-danger'>Partners</h1>
                    </Col>
                    <PartnersCarousel />
                </Container>
            </Container>
